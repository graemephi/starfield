...
#line 642 "C:\\code\\starfield\\starfield\\starfield.ion"
extern noir_float2 starfield_diffraction_rotation;

#line 225 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 645 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 567 "C:\\code\\starfield\\starfield\\stars.ion"
...
#line 581 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 62 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 220 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 102 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 560 "C:\\code\\starfield\\starfield\\stars.ion"
...
#line 178 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 501 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 632 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 590 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 209 "C:\\code\\starfield\\starfield\\math.ion"
void starfield_push_random_state(uint32_t seed);

#line 214
void starfield_pop_random_state(void);

#line 689 "C:\\code\\starfield\\starfield\\starfield.ion"
float starfield_perlin_octaves(noir_float2 p, float grid_size);

#line 497 "C:\\code\\starfield\\starfield\\stars.ion"
noir_float2 starfield_random_warp(noir_float2 p, float scale);

#line 739 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 554 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 164 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 572 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 621 "C:\\code\\starfield\\starfield\\starfield.ion"
float starfield_srgb(float val);

#line 130 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 276 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 599 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 208 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 722 "C:\\code\\starfield\\starfield\\starfield.ion"
...
#line 138 "C:\\code\\starfield\\starfield\\math.ion"
...
#line 82 "C:\\code\\starfield\\starfield\\math.ion"
...
const TypeInfo *typeinfo_table[702] = {
    ...
    [125] = NULL, // Func
    [126] = NULL, // Func
    [127] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [9]), .align = alignof(char [9]), .base = TYPEID(3, TYPE_CHAR, char), .count = 9},
    [128] = NULL, // Func
    [129] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [11]), .align = alignof(char [11]), .base = TYPEID(3, TYPE_CHAR, char), .count = 11},
    [130] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(4, TYPE_UCHAR, uchar)},
    [131] = NULL, // Func
    [132] = NULL, // Func
    [133] = NULL, // Func
    [134] = NULL, // Func
    ...
    [137] = NULL, // Func
    [138] = NULL, // Func
    [139] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(87, TYPE_STRUCT, starfield_Tex)},
    [140] = NULL, // Func
    [141] = NULL, // Func
    [142] = NULL, // Func
    [143] = NULL, // Func
    ...
    [149] = NULL, // Func
    [150] = NULL, // Func
    [151] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(14, TYPE_FLOAT, float)},
    [152] = NULL, // Func
    [153] = NULL, // Func
    [154] = NULL, // Func
    [155] = NULL, // Func
    [156] = NULL, // Func
    [157] = NULL, // Func
    [158] = &(TypeInfo){TYPE_CONST, .size = 0, .align = 0, .base = TYPEID0(1, TYPE_VOID)},
    [159] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID0(158, TYPE_CONST)},
    [160] = NULL, // Func
    [161] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(104, TYPE_STRUCT, starfield_Rect)},
    [162] = NULL, // Func
    [163] = NULL, // Func
    [164] = NULL, // Func
    [165] = NULL, // Func
    ...
    [173] = NULL, // Func
    [174] = NULL, // Func
    [175] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [7]), .align = alignof(char [7]), .base = TYPEID(3, TYPE_CHAR, char), .count = 7},
    [176] = NULL, // Func
    [177] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [18]), .align = alignof(char [18]), .base = TYPEID(3, TYPE_CHAR, char), .count = 18},
    [178] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_DisplayMode), .align = alignof(SDL_DisplayMode), .name = "SDL_DisplayMode", .num_fields = 5, .fields = (TypeFieldInfo[]) {
    ...
    [179] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(178, TYPE_STRUCT, SDL_DisplayMode)},
    [180] = NULL, // Func
    [181] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [26]), .align = alignof(char [26]), .base = TYPEID(3, TYPE_CHAR, char), .count = 26},
    [182] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [5]), .align = alignof(char [5]), .base = TYPEID(3, TYPE_CHAR, char), .count = 5},
    [183] = NULL, // Enum
    [184] = NULL, // Func
    [185] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [23]), .align = alignof(char [23]), .base = TYPEID(3, TYPE_CHAR, char), .count = 23},
    [186] = NULL, // Func
    [187] = NULL, // Func
    [188] = NULL, // Incomplete array type
    [189] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [2]), .align = alignof(char [2]), .base = TYPEID(3, TYPE_CHAR, char), .count = 2},
    [190] = NULL, // Enum
    [191] = NULL, // Func
    [192] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(int [275]), .align = alignof(int [275]), .base = TYPEID(8, TYPE_INT, int), .count = 275},
    [193] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(8, TYPE_INT, int)},
    [194] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(int [512]), .align = alignof(int [512]), .base = TYPEID(8, TYPE_INT, int), .count = 512},
    [195] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_AudioSpec), .align = alignof(SDL_AudioSpec), .name = "SDL_AudioSpec", .num_fields = 9, .fields = (TypeFieldInfo[]) {
        ...
        {"callback", .type = TYPEID(196, TYPE_FUNC, void (*)(void *, uchar *, int)), .offset = offsetof(SDL_AudioSpec, callback)},
        {"userdata", .type = TYPEID(16, TYPE_PTR, void *), .offset = offsetof(SDL_AudioSpec, userdata)},
    }},
    [196] = NULL, // Func
    [197] = &(TypeInfo){TYPE_CONST, .size = sizeof(SDL_AudioSpec const ), .align = alignof(SDL_AudioSpec const ), .base = TYPEID(195, TYPE_STRUCT, SDL_AudioSpec)},
    [198] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(197, TYPE_CONST, SDL_AudioSpec const )},
    [199] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(195, TYPE_STRUCT, SDL_AudioSpec)},
    [200] = NULL, // Func
    [201] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [20]), .align = alignof(char [20]), .base = TYPEID(3, TYPE_CHAR, char), .count = 20},
    [202] = NULL, // Func
    ...
    [206] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(starfield_Color [15]), .align = alignof(starfield_Color [15]), .base = TYPEID(88, TYPE_STRUCT, starfield_Color), .count = 15},
    [207] = NULL, // Func
    [208] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(16, TYPE_PTR, void *)},
    [209] = NULL, // Func
    [210] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(86, TYPE_PTR, starfield_Star *)},
    [211] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(starfield_BufHeader), .align = alignof(starfield_BufHeader), .name = "starfield_BufHeader", .num_fields = 3, .fields = (TypeFieldInfo[]) {
        ...
        {"data", .type = TYPEID(214, TYPE_ARRAY, uchar [1]), .offset = offsetof(starfield_BufHeader, data)},
    }},
    [212] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(211, TYPE_STRUCT, starfield_BufHeader)},
    [213] = NULL, // Func
    [214] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(uchar [1]), .align = alignof(uchar [1]), .base = TYPEID(4, TYPE_UCHAR, uchar), .count = 1},
    [215] = NULL, // Func
    [216] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [17]), .align = alignof(char [17]), .base = TYPEID(3, TYPE_CHAR, char), .count = 17},
    [217] = NULL, // Func
    [218] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [16]), .align = alignof(char [16]), .base = TYPEID(3, TYPE_CHAR, char), .count = 16},
    [219] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(54, TYPE_STRUCT, noir_DigitalButton)},
    [220] = NULL, // Func
    [221] = &(TypeInfo){TYPE_UNION, .size = sizeof(SDL_Event), .align = alignof(SDL_Event), .name = "SDL_Event", .num_fields = 5, .fields = (TypeFieldInfo[]) {
        {"type", .type = TYPEID(9, TYPE_UINT, uint), .offset = offsetof(SDL_Event, type)},
        {"key", .type = TYPEID(222, TYPE_STRUCT, SDL_KeyboardEvent), .offset = offsetof(SDL_Event, key)},
        {"text", .type = TYPEID(224, TYPE_STRUCT, SDL_TextInputEvent), .offset = offsetof(SDL_Event, text)},
        {"motion", .type = TYPEID(226, TYPE_STRUCT, SDL_MouseMotionEvent), .offset = offsetof(SDL_Event, motion)},
        {"button", .type = TYPEID(227, TYPE_STRUCT, SDL_MouseButtonEvent), .offset = offsetof(SDL_Event, button)},
    }},
    [222] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_KeyboardEvent), .align = alignof(SDL_KeyboardEvent), .name = "SDL_KeyboardEvent", .num_fields = 8, .fields = (TypeFieldInfo[]) {
        ...
        {"keysym", .type = TYPEID(223, TYPE_STRUCT, SDL_Keysym), .offset = offsetof(SDL_KeyboardEvent, keysym)},
    }},
    [223] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_Keysym), .align = alignof(SDL_Keysym), .name = "SDL_Keysym", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        {"scancode", .type = TYPEID(190, TYPE_NONE, SDL_Scancode), .offset = offsetof(SDL_Keysym, scancode)},
    ...
    [224] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_TextInputEvent), .align = alignof(SDL_TextInputEvent), .name = "SDL_TextInputEvent", .num_fields = 4, .fields = (TypeFieldInfo[]) {
        ...
        {"text", .type = TYPEID(225, TYPE_ARRAY, char [32]), .offset = offsetof(SDL_TextInputEvent, text)},
    }},
    [225] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [32]), .align = alignof(char [32]), .base = TYPEID(3, TYPE_CHAR, char), .count = 32},
    [226] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_MouseMotionEvent), .align = alignof(SDL_MouseMotionEvent), .name = "SDL_MouseMotionEvent", .num_fields = 9, .fields = (TypeFieldInfo[]) {
    ...
    [227] = &(TypeInfo){TYPE_STRUCT, .size = sizeof(SDL_MouseButtonEvent), .align = alignof(SDL_MouseButtonEvent), .name = "SDL_MouseButtonEvent", .num_fields = 10, .fields = (TypeFieldInfo[]) {
    ...
    [228] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(221, TYPE_UNION, SDL_Event)},
    [229] = NULL, // Func
    [230] = NULL, // Enum
    [231] = NULL, // Func
    [232] = NULL, // Func
    [233] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [21]), .align = alignof(char [21]), .base = TYPEID(3, TYPE_CHAR, char), .count = 21},
    [234] = NULL, // Func
    [235] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(char [24]), .align = alignof(char [24]), .base = TYPEID(3, TYPE_CHAR, char), .count = 24},
    [236] = NULL, // Func
    [237] = NULL, // Func
    [238] = NULL, // Func
    [239] = NULL, // Func
    ...
    [267] = NULL, // Func
    [268] = NULL, // Func
    [269] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(40, TYPE_STRUCT, noir_Event)},
    [270] = NULL, // Func
    [271] = NULL, // Func
    [272] = NULL, // Func
    [273] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(9, TYPE_UINT, uint)},
    [274] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(273, TYPE_PTR, uint *)},
    [275] = NULL, // Func
    [276] = NULL, // Func
    [277] = NULL, // Func
    [278] = NULL, // Func
    ...
    [287] = NULL, // Func
    [288] = NULL, // Func
    [289] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(46, TYPE_STRUCT, noir_int2)},
    ...
    [302] = NULL, // Func
    [303] = NULL, // Func
    [304] = NULL, // No associated type
    [305] = NULL, // No associated type
    [306] = NULL, // No associated type
    [307] = NULL, // Func
    [308] = NULL, // Func
    ...
    [324] = NULL, // Func
    [325] = NULL, // Func
    [326] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(15, TYPE_DOUBLE, double)},
    [327] = NULL, // Func
    [328] = NULL, // Func
    [329] = NULL, // Func
    [330] = NULL, // Func
    ...
    [340] = NULL, // Func
    [341] = NULL, // Func
    [342] = &(TypeInfo){TYPE_CONST, .size = sizeof(char (*const )), .align = alignof(char (*const )), .base = TYPEID(18, TYPE_PTR, char *)},
    [343] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(342, TYPE_CONST, char (*const ))},
    [344] = NULL, // Func
    ...
    [390] = NULL, // Func
    [391] = NULL, // Func
    [392] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(6, TYPE_SHORT, short)},
    [393] = NULL, // Func
    [394] = NULL, // Func
    [395] = NULL, // Func
    [396] = &(TypeInfo){TYPE_CONST, .size = sizeof(short const ), .align = alignof(short const ), .base = TYPEID(6, TYPE_SHORT, short)},
    [397] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(396, TYPE_CONST, short const )},
    [398] = NULL, // Func
    [399] = NULL, // Func
    [400] = NULL, // Func
    [401] = NULL, // Func
    ...
    [412] = NULL, // Func
    [413] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(12, TYPE_LLONG, llong)},
    [414] = NULL, // Func
    [415] = NULL, // No associated type
    [416] = NULL, // No associated type
    [417] = NULL, // Func
    [418] = &(TypeInfo){TYPE_CONST, .size = sizeof(llong const ), .align = alignof(llong const ), .base = TYPEID(12, TYPE_LLONG, llong)},
    [419] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(418, TYPE_CONST, llong const )},
    [420] = NULL, // Func
    [421] = NULL, // Func
    [422] = NULL, // Func
    [423] = NULL, // No associated type
    [424] = NULL, // No associated type
    [425] = NULL, // No associated type
    [426] = NULL, // Func
    [427] = NULL, // Func
    [428] = NULL, // Func
    [429] = NULL, // Func
    ...
    [432] = NULL, // Func
    [433] = NULL, // Func
    [434] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(130, TYPE_PTR, uchar *)},
    [435] = NULL, // Func
    [436] = NULL, // No associated type
    [437] = NULL, // No associated type
    [438] = NULL, // Func
    [439] = &(TypeInfo){TYPE_CONST, .size = sizeof(uchar const ), .align = alignof(uchar const ), .base = TYPEID(4, TYPE_UCHAR, uchar)},
    [440] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(439, TYPE_CONST, uchar const )},
    [441] = NULL, // Func
    [442] = NULL, // Func
    [443] = NULL, // Func
    [444] = NULL, // Func
    ...
    [470] = NULL, // Func
    [471] = NULL, // Func
    [472] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(470, TYPE_FUNC, int (*)(void *, SDL_Event *))},
    [473] = NULL, // Func
    [474] = NULL, // Func
    [475] = NULL, // Func
    [476] = NULL, // No associated type
    [477] = NULL, // Func
    [478] = NULL, // Func
    [479] = NULL, // Func
    [480] = NULL, // Func
    ...
    [482] = NULL, // Func
    [483] = NULL, // Func
    [484] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(77, TYPE_STRUCT, SDL_Rect)},
    [485] = NULL, // Func
    [486] = NULL, // Func
    ...
    [494] = NULL, // Func
    [495] = NULL, // Func
    [496] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(495, TYPE_FUNC, void (*)(void *, int, SDL_LogPriority, char const (*)))},
    [497] = NULL, // Func
    [498] = NULL, // Func
    ...
    [512] = NULL, // Func
    [513] = NULL, // Func
    [514] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(7, TYPE_USHORT, ushort)},
    [515] = NULL, // Func
    [516] = NULL, // Func
    [517] = NULL, // No associated type
    [518] = NULL, // Func
    [519] = NULL, // Func
    [520] = NULL, // Func
    ...
    [522] = NULL, // Func
    [523] = NULL, // Func
    [524] = NULL, // No associated type
    [525] = NULL, // No associated type
    ...
    [532] = NULL, // Func
    [533] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(52, TYPE_PTR, SDL_Window *)},
    [534] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(73, TYPE_PTR, SDL_Renderer *)},
    [535] = NULL, // Func
    [536] = NULL, // Func
    [537] = NULL, // Func
    [538] = NULL, // Func
    ...
    [572] = NULL, // Func
    [573] = NULL, // Func
    [574] = &(TypeInfo){TYPE_CONST, .size = sizeof(double const ), .align = alignof(double const ), .base = TYPEID(15, TYPE_DOUBLE, double)},
    [575] = NULL, // Func
    [576] = NULL, // Func
    [577] = NULL, // Func
    [578] = NULL, // Func
    ...
    [604] = NULL, // Func
    [605] = NULL, // Func
    [606] = NULL, // No associated type
    [607] = NULL, // No associated type
    ...
    [687] = NULL, // Func
    [688] = NULL, // Func
    [689] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(13, TYPE_ULLONG, ullong)},
    [690] = &(TypeInfo){TYPE_PTR, .size = sizeof(void *), .align = alignof(void *), .base = TYPEID(689, TYPE_PTR, ullong *)},
    [691] = &(TypeInfo){TYPE_ARRAY, .size = sizeof(starfield_Star [1]), .align = alignof(starfield_Star [1]), .base = TYPEID(85, TYPE_STRUCT, starfield_Star), .count = 1},
...
// Definitions
#line 747 "C:\\code\\starfield\\starfield\\starfield.ion"
int main(int argc, char (*(*argv))) {
...
#line 516
void starfield_draw_nebula(starfield_Image (*img), starfield_Tex (*density)) {
    starfield_Image nebula = starfield_make_image(img->size);
    #line 519
    starfield_Color c = starfield_random_random_star_color((noir_float2){0, 3});
    #line 521
    ...
    #line 525
    float turbulence = starfield_randomr(0, 0.2f);
    float detail = starfield_random_normal();
    #line 528
    float negative_space = 1.f;
    #line 530
    for (starfield_PixelIter it = starfield_pixel_iter_begin(&(nebula), (starfield_Rect){0}); starfield_pixel_iter_next(&(it));) {
        ...
        noir_float2 pos = starfield_random_warp(it.pos, ((d) * (turbulence)) * (((1) - (p))));
        float w1 = starfield_clamp_low(0, starfield_worley_octaves(pos, 5, 2));
        float w2 = (4) * (starfield_clamp_low(0, starfield_worley_octaves(starfield_add2s(pos, 1.2341f), 5, 2)));
        float w3 = (6) * (starfield_clamp_low(0, starfield_worley_octaves(starfield_add2s(pos, 2.341f), (10) + (detail), 2)));
        float w = ((w1) * (w1)) * (((w2) * (w3)));
    ...
    for (starfield_PixelIter it = starfield_pixel_iter_begin(img, (starfield_Rect){0}); starfield_pixel_iter_next(&(it));) {
        ...
        starfield_Color x = starfield_color_lerp(nb, nnb, .4f);
        starfield_Color y = starfield_color_add(n, x);
        starfield_Color z = starfield_color_pow(y, (1) + ((d) * (negative_space)));
        #line 553
...
#line 497 "C:\\code\\starfield\\starfield\\stars.ion"
noir_float2 starfield_random_warp(noir_float2 p, float scale) {
    noir_float2 q = starfield_mul2s(p, 4);
    noir_float2 a = starfield_perlin_gradient(starfield_float2_to_int2(starfield_add2(q, (noir_float2){0, 0})));
    noir_float2 b = starfield_perlin_gradient(starfield_float2_to_int2(starfield_add2(q, (noir_float2){1, 0})));
    noir_float2 c = starfield_perlin_gradient(starfield_float2_to_int2(starfield_add2(q, (noir_float2){0, 1})));
    noir_float2 d = starfield_perlin_gradient(starfield_float2_to_int2(starfield_add2(q, (noir_float2){1, 1})));
    #line 504
    noir_float2 r = {(q.x) - ((int)(q.x)), (q.y) - ((int)(q.y))};
    #line 506
    ...
    #line 513
    return starfield_add2(p, starfield_mul2s(abcd, scale));
}
...
#line 269 "C:\\code\\starfield\\starfield\\math.ion"
noir_float2 starfield_lerp2(noir_float2 a, noir_float2 b, float t) {
    return (noir_float2){((((1) - (t))) * (a.x)) + ((t) * (b.x)), ((((1) - (t))) * (a.y)) + ((t) * (b.y))};
}
...
float starfield_worley_distance(noir_int2 square, noir_float2 p, float poisson_alpha) {
    ...
    #line 705
    if ((k) > (0)) {
        noir_float2 min_point = starfield_add2(s, (noir_float2){starfield_random01(), starfield_random01()});
        result = starfield_distance2(min_point, p);
        for (int i = 1; (i) < (k); (i)++) {
    ...
    #line 718
    starfield_pop_random_state();
    return starfield_clamp(0, max_distance, result);
}
